...
LR_START = 0.008        # learning rate
LR_DECAY = 0.82         # per epoch (faster decay to stabilize late training)
ALPHA_START = 0.15      # label smoothing (constant - provides regularization)
